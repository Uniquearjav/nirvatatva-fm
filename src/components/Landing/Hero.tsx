...
export default function Hero() {
  return (
    <section className="relative font-luxury isolate overflow-hidden">
      ...
      <div className="container py-28 sm:py-36 text-center text-white">
        <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 font-luxury text-xs backdrop-blur">
          <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
          End-to-end export solutions
        </span>
        <h1 className="mt-6 font-bold font-luxury tracking-tight text-4xl sm:text-5xl md:text-6xl">
          Furniture & steel scrap exporter and trader
        </h1>
        <p className="mx-auto mt-4 max-w-3xl font-luxury text-white/80">
        ...
        <div className="mt-8 font-luxury flex items-center justify-center gap-3">
          <Link href="/shop">
